...
char const*const LED_FREQ_FILE
        = "/sys/class/leds/led:red/device/grpfreq";

char const*const LED_PWM_FILE
        = "/sys/class/leds/led:red/device/grppwm";

char const*const LED_BLINK_FILE
        = "/sys/class/leds/led:red/device/blink";

char const*const LED_LOCK_UPDATE_FILE
        = "/sys/class/leds/led:red/device/lock";
