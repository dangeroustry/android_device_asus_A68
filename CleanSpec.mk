...
$(call add-clean-step, find $(OUT_DIR) -name "lights.qcom*" -print0 | xargs -0 rm -f)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/A68/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/A68/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A68/root/default.prop)
